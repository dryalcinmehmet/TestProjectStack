...
<body>
  ...
  <div id="locals">
    <img src="{% static 'dash/img/blue-shell.jpg' %}" />
    <img src="{% static 'dash/{% static 'dash/img/bowser-jr.jpg' %}' %}" />
    <!-- thunder cloud has bad permissions, should 403 -->
    <img src="{% static 'dash/{% static 'dash/img/not-there.jpg' %}' %}" />
  </div>
  ...
  <div id="jquery-fail">
    ...
    <img src="{% static 'dash/{% static 'dash/img/not-there.jpg' %}' %}" />
    <img src="{% static 'dash/foobar.jpg' %}" />
  </div>
